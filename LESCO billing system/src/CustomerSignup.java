...
// Create the JTextField for Phone input
        ...
        passwordField.setText("Enter CNIC"); // Placeholder text


        // Create a JLabel for Phone
        JLabel CpasswordLabel = new JLabel("Confirm CNIC");
...
// Create the JTextField for Phone input
        ...
        CpasswordField.setText("Enter Confirm CNIC"); // Placeholder text
